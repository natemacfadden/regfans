...
print(f"constructed the following fan: {vc}")
print()

# read some properies of the fan
print(f"the default triangulation has cones {fan.cones()}")
print(f"some heights defining the triangulation are {fan.heights().tolist()}")
print(f"is the default triangulation valid? {fan.is_valid()}")
print(f"is the default triangulation fine? {fan.is_fine()}")
print(f"is the default triangulation regular? {fan.is_regular()}")
print(f"does the default triangulation define a triangulation of the associated PC? {fan.respects_ptconfig()}")
